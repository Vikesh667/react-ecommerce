        ...
        <div className="bg-white">
          <div>
            {/* Mobile filter dialog */}
               <MobileFilter mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} handleFilter={handleFilter} handleSort={handleSort}/>
...
function MobileFilter({mobileFiltersOpen,setMobileFiltersOpen,handleFilter,handleSort}) {
  return(
