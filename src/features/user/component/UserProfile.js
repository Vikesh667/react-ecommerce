...
import { UpdateUserAsync, selectUserInfo } from "../userSilce";
import { useForm } from "react-hook-form";

export function UserProfile() {
  const dispatch = useDispatch();
  const [selectedEditIndex, setSelectedEditIndex] = useState(-1);
  const [showAddAddressForm, setShowAddressFrom] = useState(-1);
  ...
  return (
    <div className="mx-auto bg-white mt-12 max-w-6xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
        ...
        <button
        onClick={e=>{setShowAddressFrom(true);setSelectedEditIndex(-1)}}
          type="submit"
                ...
                <div className="space-y-12">
                  ...
                  <div className="mt-6 flex items-center justify-end gap-x-6">
                    <button
                      ...
                      type="submit"
                      className="rounded-md my-5 bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      cancel
                    </button>
                    <button
